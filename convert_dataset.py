...
def convert_data(input_dataset, output_dataset, last_index):
    ...
    data_converter = DataConverter.DataConverter(input_dataset, output_dataset, class_color_info_map)
...
parser.add_argument("last_index", type=str, help="the last index of the image that has been converted")
