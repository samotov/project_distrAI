...
class BasicSynchronousClient(object):
    ...
    def setup_camera(self):
        ...
        camera_transform = carla.Transform(carla.Location(x=1.6, z=1.7), carla.Rotation(pitch=-15))
        self.camera_radar = self.world.spawn_actor(self.camera_blueprint('sensor.other.radar'), camera_transform, attach_to=self.car)
        weak_self = weakref.ref(self)
        ...
        self.camera_radar.calibration = calibration
